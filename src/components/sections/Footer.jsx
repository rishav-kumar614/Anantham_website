    ...
    return (
        <footer className="relative bg-[#0A0A0A] overflow-hidden pt-16 pb-12">
            ...
            <div className="relative z-10 max-w-[1600px] mx-auto px-6 md:px-12 lg:px-24">
                ...
                <div className="mt-16 pt-8 border-t border-white/10 text-white/40 text-[11px] font-light leading-relaxed space-y-3">
                ...
                <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-8">
                    {/* Copyright Info */}
