                ...
                {isMenuOpen && (
                    <>
                        ...
                        >
                            ...
                            {/* Header inside Menu */}
                            <div className="flex justify-between items-center px-8 md:px-10 py-6 border-b border-white/5 bg-black/20">
                                <motion.div
                                    ...
                                    {[
                                        ...
                                        >
                                            <Link
                                                ...
                                                className="group relative flex items-center justify-between px-5 py-3.5 bg-white/[0.02] hover:bg-white/[0.05] border border-white/[0.05] hover:border-[#C9A961]/30 rounded-xl transition-all duration-300 overflow-hidden"
                                            >
                                                ...
                                                <div className="relative flex items-center gap-4">
                                                    <span className="text-[#C9A961]/40 text-[10px] font-bold tracking-widest group-hover:text-[#C9A961] transition-colors duration-300">
                                                        0{idx + 1}
                                                    </span>
                                                    <span className="text-sm md:text-base font-light tracking-[0.1em] text-white/80 group-hover:text-white transition-all duration-300 uppercase">
                                                        {item.label}
                                                    </span>
                                                </div>

                                                <motion.div
                                                    className="w-4 h-[1.5px] bg-white/20 group-hover:bg-[#C9A961] transition-all duration-300"
                                                    whileHover={{ width: 24 }}
                                                />
                                            </Link>
                                        </motion.div>
                            ...
                            <motion.div
                                ...
                                className="px-8 md:px-10 py-5 border-t border-white/5 bg-black/10"
                            >
                                <div className="flex items-center justify-between text-white/30 text-[9px] uppercase font-bold tracking-[0.4em]">
